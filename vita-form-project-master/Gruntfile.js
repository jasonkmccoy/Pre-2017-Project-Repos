/*!
 * Vita Database Software Project Gruntfile
 * http://domco.us
 * @author Jason McCoy
 */
...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            livereload: {
                ...
                files: ['<%= project.app %>/{,*/}*.html', '<%= project.app %>/{,*/}*.php', '<%= project.assets %>/css/*.css', '<%= project.assets %>/js/{,*/}*.js', '<%= project.assets %>/{,*/}*.{png,jpg,jpeg,gif,webp,svg}']
            }
        },
        ...
        uncss: {
            dist: {
                files: {
                    'app/assets/css/style.min.css': ['app/index.html', 'app/filters.html', 'app/template.html']
                }
            }
        },
     ...
     */
    grunt.registerTask('default', ['sass:dev', 'autoprefixer', 'uncss', 'jshint', 'concat:dev', 'connect:livereload', 'uncss', 'open', 'watch']);
     ...
     */
    grunt.registerTask('build', ['sass:dist', 'jshint', 'autoprefixer', 'uglify', 'uncss', 'processhtml']);
