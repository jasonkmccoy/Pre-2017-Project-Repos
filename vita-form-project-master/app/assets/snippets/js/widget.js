...
jQuery("#chat-tab-image").on("click", function() {
    ...
    if (combinedWidth > bodyWidth) {
        ...
        var px = "px";
        var widthString = widthToScroll + px;
        ...
        var right = "-";
        var widthToScroll = jQuery("#customer-chat-content-contact-form").width() + 3;

        var px = "px";
        var widthString = right + widthToScroll + px;
