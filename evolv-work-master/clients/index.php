...
<head>
    <meta charset="utf-8">
    <title>Evolv Client Projects</title>
...
<body>
    <div id="wrapper">
        <div id="content">
          <ul>
          <li><a href="eNewsletters/index.php">HTML Email Newsletters</a></li>
            <li><a href="EPCs/index.php">Email Preference Centers (EPC)</a></li>
             <li><a href="evolv-wordpress-sites/index.php">Evolv Wordpress Sites</a></li>
             <li><a href="misc-projects/index.php">Misc. Projects</a></li>
          </ul>
<?php
