...
<head>
    <meta charset="utf-8">
    <title>Evolv HTML Email Projects</title>
...
<body>
    <div id="wrapper">
        <div id="content">
          <ul>
          <li><a href="blueprint/index.php">Blueprint</a></li>
            <li><a href="cpha/index.php">CPHA</a></li>
             <li><a href="fpsc/index.php">FPSC</a></li>
             <li><a href="nacha/index.php">NACHA</a></li>
             <li><a href="enewsletter-training-materials/index.php">Evolv eNewsletter Training Materials</a></li>
          </ul>
<?php
